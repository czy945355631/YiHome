...
<#include "header.ftl">
    ...
    <div class="page-inner">
        <div class="page-title">
            <h3 class="breadcrumb-header">新增楼层</h3>
        </div>
        <div id="main-wrapper">
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-white">
                        <div class="panel-body">
                            <form class="form-inline" method="post" action="/BsPage/doFloorAdd">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" name="floorname" placeholder="规格名称">
                                </div>
                                <div class="form-group">
