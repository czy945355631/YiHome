...
<#include "header.ftl">
    ...
    <div class="page-inner">
        <div class="page-title">
            <h3 class="breadcrumb-header">修改商品</h3>
        </div>
        <div id="main-wrapper">
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-white">
                        <div class="panel-body">
                            <form class="form-inline" action="../../BsPage/goods/doGoodsUpdate" method="post" enctype="multipart/form-data">
                                <div class="panel-title">
                                    ...
                                    <div class="form-group">
                                        <input type ="checkbox" <#if goods.showstatus==0> value ="0"  <#elseif goods.showstatus==1> value ="1" class="checked" checked="checked" </#if>    name ="showstatus" onclick ="this.value =(this.value == 0)?1:0">
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        <select name="brandId" id="" class="form-control">
                                            <#list brands as brands>
                                                <#if brands.id = goods.brandId>
                                                    <option selected="selected" value="${brands.id}">${brands.brandname}</option>
                                                    <#elseif brands.id != goods.brandId>
                                    ...
                                    <div class="form-group">
                                        <select name="classesId" id="" class="form-control">
                                            <#list classes as classes>
                                                <#if classes.id = goods.classesId>
                                                    <option selected="selected" value="${classes.id}">${classes.classesname}</option>
                                                    <#elseif classes.id != goods.classesId>
                                ...
                                <div class="panel-title">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="oldPrice" value="${goods.oldPrice?c}">
                                    </div>
                                    <div class="seq">商品现价</div>
                                    <div class="form-group">
                                        <input type="number" class="form-control" name="nowPrice" value="${goods.nowPrice?c}">
                                    </div>
                                </div>
                                <div class="panel-title">
                                    <div class="seq">商品货号</div>
                                    <div class="form-group">
                                        <input type="number" class="form-control" name="artno" value="${goods.artno?c}">
                                    </div>
                                    <div class="seq">商品库存</div>
                                    <div class="form-group">
                                        <input type="number" class="form-control" name="store" value="${goods.store?c}">
                                    </div>
                                </div>
                                <div class="panel-title">
                                    <div class="seq">商品体积</div>
                                    <div class="form-group">
                                        <input type="number" class="form-control" name="volume" value="${goods.volume}">
                                    </div>
                                    <div class="seq">商品重量</div>
                                    <div class="form-group">
                                        <input type="number" class="form-control" name="weight" value="${goods.weight}">
                                    </div>
                                </div>
                                        ...
                                        <div class="form-item">
                                            ...
                                            <div class="form-group">
                                                <select name="spec[0].id" class="form-control spec">
                                                    ...
                                                    <#list spec as spec>
                                                        <#if selectedspec[0].specid == spec.id>
                                                            <option id="spec0" value="${spec.id}" selected="selected">${spec.specname}</option>
                                                        <#elseif selectedspec[0].specid != spec.id>
                                                            <option id="spec0" value="${spec.id}" >${spec.specname}</option>
                                                        </#if>
                                                    </#list>
                                                </select>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select id="specv0" name="spec[0].specValues[0].id" class="selectpicker specv">
                                                    <option id="specvdefault" value="-1 ">请选择规格值</option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-item">
                                            ...
                                            <div class="form-group">
                                                <select name="spec[1].id"  class="form-control spec">
                                                    <option value="-1">请选择规格</option>
                                                    <#list spec as spec>
                                                        <#if selectedspec[1].specid == spec.id>
                                                            <option id="spec1" value="${spec.id}" selected="selected">${spec.specname}</option>
                                                        <#elseif selectedspec[1].specid != spec.id>
                                                            <option id="spec1" value="${spec.id}" >${spec.specname}</option>
                                                        </#if>
                                                    </#list>
                                                </select>
                                            </div>
                                ...
                                <div class="panel-title">
                                    ...
                                    <textarea name="datails" id="editor1" rows="10" cols="80">${goods.datails}</textarea>
                                </div>
                                <div id="main-wrapper">
...
<script>
    ...
    $(document).ready(function () {
        ...
        showspecv0list(${selectedspec[0].specid});
        showspecv1list(${selectedspec[1].specid});
    });

    function showspecv0list(specid) {
        $.ajax({
            url:"/Bsjson/getGoodsaddPageSpecvlist",
            type:"post",
            data:{specid:specid},
            success:function(data){
                $("#specv0").find("option").remove();
                data.list.forEach(function (item, index) {
                    var specv = "<option hidden value=" + item.id + ">" + item.specvname + "</option>"
                    $("#specv0").append(specv);
                });
                $("#specv0").selectpicker('refresh');
            }
        });
    }
    function showspecv1list(specid) {
        $.ajax({
            url:"/Bsjson/getGoodsaddPageSpecvlist",
            type:"post",
            data:{specid:specid},
            success:function(data){
                $("#specv1").find("option").remove();
                data.list.forEach(function (item, index) {
                    var specv = "<option hidden value=" + item.id + ">" + item.specvname + "</option>"
                    $("#specv1").append(specv);
                });
                $("#specv1").selectpicker('refresh');
            }
        });
    }
