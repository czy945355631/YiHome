...
<#include "header.ftl">
    ...
    <div class="page-inner">
        ...
        <div class="page-title">
            <h3 class="breadcrumb-header">规格管理</h3>
        </div>

        <div class="panel-heading">
            <form action="/BsPage/goSpecAdd">
                <button type="submit" class="btn btn-success" data-toggle="modal"
                        data-target="#myModal">新增规格
                </button>
            </form>
        ...
        $("#example").dataTable( {
            ...
            "aoColumnDefs": [
                ...
                {"aTargets":[3],"mRender":function(data,type,full){
                    ...
                    var b ="<input type='button' value='修改' onclick=javascrtpt:doupdate("+data+")>"
                        return a + b;
                    }
                }
            ]
